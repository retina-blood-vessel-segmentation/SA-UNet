...
data_location = ''
training_images_loc = data_location + 'DROPS/train/images/'
training_label_loc = data_location + 'DROPS/train/labels/'
validate_images_loc = data_location + 'DROPS/validate/images/'
validate_label_loc = data_location + 'DROPS/validate/labels/'
...
for i in train_files:
    ...
    label = mc.imread(str(Path(training_label_loc) / (Path(i).stem + ".png")))
...
for i in validate_files:
    ...
    label = mc.imread(str(Path(validate_label_loc) / (Path(i).stem + ".png")))
...
history=model.fit(x_train, y_train,
                ...
                shuffle=True,
                callbacks= [TensorBoard(log_dir='./autoencoder-drops'), model_checkpoint])
